...
std::string &Cgi::getTemplate(void) { return (_template); }
void Cgi::setTemplate(void)
{
...
std::string &Cgi::getUploadDir(void) { return (_upload_dir); }
...
std::string &Cgi::getErrorPath(void) { return (_error_path); }
...
const std::string Cgi::emptyFolder(void) const
{
...
const std::string Cgi::generateCards(std::string path_info, std::string url) const
{
...
void Cgi::getFile(const std::string &full_path, const std::string &path_info, const std::string &url,
...
std::string Cgi::loadTemplateFile(const std::string &path_info)
{
...
std::string Cgi::generateHeaders(const std::string &status, size_t content_length, const std::string &filename)
{
...
void Cgi::generateResponse(const std::string &status, const std::string &content, const std::string &fullPath, const std::string &templateStr = "")
{
...
void Cgi::getDirectories(const std::string &full_path, const std::string &path_info)
{
...
std::string Cgi::generateHTMLList(const std::vector<std::string> &files)
{
...
void Cgi::getImage(const std::string full_path, const std::string path_info, const std::string error_path, const std::string url, const std::string message, const std::string status)
{
